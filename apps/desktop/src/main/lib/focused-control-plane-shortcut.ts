...
export function focusedDashboardWebShortcuts(
	...
	return [
		...
		{ accelerator: `${prefix}+.`, shortcut: "SIDEBAR_ACTION_MENU" },
		{ accelerator: `${prefix}+P`, shortcut: "SIDEBAR_ACTION_PIN" },
		{ accelerator: `${prefix}+A`, shortcut: "SIDEBAR_ACTION_ARCHIVE" },
		{
			accelerator: `${prefix}+Shift+A`,
			shortcut: "SIDEBAR_ACTION_HARD_ARCHIVE",
		},
		{ accelerator: `${prefix}+M`, shortcut: "SIDEBAR_ACTION_MOVE" },
		{
			accelerator: `${prefix}+Shift+M`,
			shortcut: "SIDEBAR_ACTION_REMOVE_FROM_FOLDER",
		},
		{ accelerator: `${prefix}+E`, shortcut: "SIDEBAR_ACTION_RENAME" },
		{ accelerator: `${prefix}+Shift+R`, shortcut: "SIDEBAR_ACTION_REPLY" },
		{ accelerator: `${prefix}+O`, shortcut: "SIDEBAR_ACTION_OPEN_BROWSER" },
		{ accelerator: `${prefix}+U`, shortcut: "SIDEBAR_ACTION_MARK_READ" },
		...
		{ accelerator: `${prefix}+Shift+,`, shortcut: "BROWSER_NARROW_SPLIT" },
		{ accelerator: `${prefix}+Shift+.`, shortcut: "BROWSER_WIDEN_SPLIT" },

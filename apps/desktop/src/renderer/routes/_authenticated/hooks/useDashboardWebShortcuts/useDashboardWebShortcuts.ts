...
export function useDashboardWebShortcuts() {
	...
	useHotkey("SIDEBAR_ACTION_CREATE", () =>
		runShortcut("SIDEBAR_ACTION_CREATE"),
	);
	useHotkey("SIDEBAR_ACTION_CREATE_FOLDER", () =>
		runShortcut("SIDEBAR_ACTION_CREATE_FOLDER"),
	);
	useHotkey("SIDEBAR_ACTION_MENU", () => runShortcut("SIDEBAR_ACTION_MENU"));
	useHotkey("SIDEBAR_ACTION_PIN", () => runShortcut("SIDEBAR_ACTION_PIN"));
	useHotkey("SIDEBAR_ACTION_ARCHIVE", () =>
		runShortcut("SIDEBAR_ACTION_ARCHIVE"),
	);
	useHotkey("SIDEBAR_ACTION_HARD_ARCHIVE", () =>
		runShortcut("SIDEBAR_ACTION_HARD_ARCHIVE"),
	);
	useHotkey("SIDEBAR_ACTION_MOVE", () => runShortcut("SIDEBAR_ACTION_MOVE"));
	useHotkey("SIDEBAR_ACTION_REMOVE_FROM_FOLDER", () =>
		runShortcut("SIDEBAR_ACTION_REMOVE_FROM_FOLDER"),
	);
	useHotkey("SIDEBAR_ACTION_COLOR", () => runShortcut("SIDEBAR_ACTION_COLOR"));
	useHotkey("SIDEBAR_ACTION_RENAME", () =>
		runShortcut("SIDEBAR_ACTION_RENAME"),
	);
	useHotkey("SIDEBAR_ACTION_REPLY", () => runShortcut("SIDEBAR_ACTION_REPLY"));
	useHotkey("SIDEBAR_ACTION_OPEN_BROWSER", () =>
		runShortcut("SIDEBAR_ACTION_OPEN_BROWSER"),
	);
	useHotkey("SIDEBAR_ACTION_MARK_READ", () =>
		runShortcut("SIDEBAR_ACTION_MARK_READ"),
	);
	useHotkey("SIDEBAR_ACTION_DELETE", () =>
		runShortcut("SIDEBAR_ACTION_DELETE"),
	);

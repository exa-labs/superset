...
describe("web command provider", () => {
	...
	it("exposes local native session shortcuts in command palette rows", () => {
		...
		expect(shortcutById.get("native.current.hide")).toBe("a");
		expect(shortcutById.get("native.current.archive")).toBe("x/X");
		...
		expect(shortcutById.get("native.capy.all")).toBe("1");
		expect(shortcutById.get("native.capy.active")).toBe("2");
		expect(shortcutById.get("native.capy.unread")).toBe("3");
		expect(shortcutById.get("native.capy.pinned")).toBe("4");
		expect(shortcutById.get("native.capy.hidden")).toBe("5");
		expect(shortcutById.get("native.capy.finished")).toBe("6");
		expect(shortcutById.get("native.devin.all")).toBe("1");
		expect(shortcutById.get("native.devin.active")).toBe("2");
		expect(shortcutById.get("native.devin.unread")).toBe("3");
		expect(shortcutById.get("native.devin.pinned")).toBe("4");
		expect(shortcutById.get("native.devin.hidden")).toBe("5");
		expect(shortcutById.get("native.devin.finished")).toBe("6");
